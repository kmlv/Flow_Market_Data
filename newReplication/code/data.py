...
plt.savefig(os.path.join(figures_dir, 'Figure6_Profit_CDF.pdf'))
plt.close()
...
plt.grid(True)
plt.legend(loc='lower right')
plt.savefig(os.path.join(figures_dir, 'FigureS3_Profit_CDF_Last10.pdf'))
plt.close()
...
plt.ylim(0, 1.1)
plt.legend(loc='lower right')
plt.savefig(os.path.join(figures_dir, 'Figure8_Cumulative_Volume.pdf'))
plt.close()
