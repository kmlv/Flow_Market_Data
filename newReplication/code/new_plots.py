...
plt.savefig(os.path.join(figures_dir, 'mean_prices.pdf'))
plt.close()
...
plt.savefig(os.path.join(figures_dir, 'Figure5a_Volume.pdf'))
plt.close()
...
plt.savefig(os.path.join(figures_dir, 'Figure5b_Surplus.pdf'))
plt.close()
